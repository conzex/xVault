...
<div class="app-container">
    <header class="header">
        <div style="display: flex; align-items: center; gap: 12px;">
            <?php if ($currentUser): ?>
                <button type="button" onclick="toggleMobileSidebar()" class="btn btn-secondary btn-sm mobile-menu-btn" style="display: none; padding: 6px; border-radius: 6px;" title="Toggle Menu">
        ...
        <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <div style="position: relative;">
                <button type="button" onclick="toggleProfileDropdown()" class="btn btn-secondary btn-sm" style="display: flex; align-items: center; gap: 8px; border-radius: 20px; padding: 4px 12px 4px 4px;">
                    ...
                    <span style="font-weight: 600; font-size: 13px; color: #1E293B; max-width: 140px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?= e($currentUser['name']) ?></span>
                ...
                <div id="profile-dropdown" style="display: none; position: absolute; right: 0; top: 100%; margin-top: 8px; width: 220px; background: #ffffff; border: 1px solid #E2E8F0; border-radius: 12px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.1); z-index: 50; padding: 6px 0;">
                    <div style="padding: 10px 16px; border-bottom: 1px solid #F1F5F9; font-size: 12px; color: #64748B;">
                        Signed in as <strong style="color: #0F172A; display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin-top: 2px;"><?= e($currentUser['email']) ?></strong>
                    </div>
